...
class Generate(object):
    ...
    """The Generate class is used to auto generate the Selenium Webdriver code."""
    ...
    def generateCode(self, content):
        ...
        #Parse Radio Buttons Input Elements
        print "\nPARSE RADIO BUTTONS"
        radios = soup.findAll('input',{'type':'radio'})
        for radio in radios:
	    print radio

        #Parse CheckBox Input Elements
        print "\nPARSE CHECKBOX BUTTONS"
        checkboxes = soup.findAll('input',{'type':'checkbox'})
        for checkbox in checkboxes:
	    print checkbox


        #Parse Text Fields Input Elements
        print "\nPARSE TEXT BOXES"
        textboxes = soup.findAll('input',{'type':'text'})
        for textbox in textboxes:
	    print textbox

        #Parse Password Field Input Elements
        print "\nPARSE TEXT BOXES"
