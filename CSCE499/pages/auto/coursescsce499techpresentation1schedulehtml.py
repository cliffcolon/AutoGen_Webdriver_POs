...
class CoursesCsce499TechPresentation1ScheduleHtml(Base):
    """
    Variable definitions of  CoursesCsce499TechPresentation1ScheduleHtml page object based on site HTML elements.
    """
    ...
    def __init__(self, testsetup, open_url=True):
        ...
        if open_url:
            self.selenium.get(self.base_url + "/tech-presentation1-schedule.html")
