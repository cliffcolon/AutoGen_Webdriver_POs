...
class CoursesCsce499RequirementsHtml(Base):
    """
    Variable definitions of  CoursesCsce499RequirementsHtml page object based on site HTML elements.
    """
    ...
    def __init__(self, testsetup, open_url=True):
        ...
        if open_url:
            self.selenium.get(self.base_url + "/requirements.html")
