...
class CoursesCsce499DocBaPhase1Html(Base):
    """
    Variable definitions of  CoursesCsce499DocBaPhase1Html page object based on site HTML elements.
    """
    ...
    def __init__(self, testsetup, open_url=True):
        ...
        if open_url:
            self.selenium.get(self.base_url + "/doc-ba-phase1.html")
