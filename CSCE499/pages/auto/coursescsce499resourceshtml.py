...
class CoursesCsce499ResourcesHtml(Base):
    """
    Variable definitions of  CoursesCsce499ResourcesHtml page object based on site HTML elements.
    """
    ...
    def __init__(self, testsetup, open_url=True):
        ...
        if open_url:
            self.selenium.get(self.base_url + "/resources.html")
