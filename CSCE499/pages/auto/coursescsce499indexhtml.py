...
class CoursesCsce499IndexHtml(Base):
    """
    Variable definitions of  CoursesCsce499IndexHtml page object based on site HTML elements.
    """
    ...
    def __init__(self, testsetup, open_url=True):
        ...
        if open_url:
            self.selenium.get(self.base_url + "/index.html")
