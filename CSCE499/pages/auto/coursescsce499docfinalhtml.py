...
class CoursesCsce499DocFinalHtml(Base):
    """
    Variable definitions of  CoursesCsce499DocFinalHtml page object based on site HTML elements.
    """
    ...
    def __init__(self, testsetup, open_url=True):
        ...
        if open_url:
            self.selenium.get(self.base_url + "/doc-final.html")
