...
class CoursesCsce499TechPresentation2ScheduleHtml(Base):
    """
    Variable definitions of  CoursesCsce499TechPresentation2ScheduleHtml page object based on site HTML elements.
    """
    ...
    def __init__(self, testsetup, open_url=True):
        ...
        if open_url:
            self.selenium.get(self.base_url + "/tech-presentation2-schedule.html")
