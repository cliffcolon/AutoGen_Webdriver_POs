...
class CoursesCsce499AcfestScheduleHtml(Base):
    """
    Variable definitions of  CoursesCsce499AcfestScheduleHtml page object based on site HTML elements.
    """
    ...
    def __init__(self, testsetup, open_url=True):
        ...
        if open_url:
            self.selenium.get(self.base_url + "/acfest-schedule.html")
