...
from pages.trails1006563winopeelaketrailoregonhtml import Trails1006563WinopeeLakeTrailOregonHtml
...
class Trails1006563WinopeeLakeTrailOregonHtml:

    @pytest.mark.nondestructive
    def test_is_id_container_locator_available(self, mozwebqa):

        page = Trails1006563WinopeeLakeTrailOregonHtml(mozwebqa)
