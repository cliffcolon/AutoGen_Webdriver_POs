...
from pages.riverraftingadventuresdeschutesriverbigeddy import RiverRaftingAdventuresDeschutesRiverBigEddy
...
class RiverRaftingAdventuresDeschutesRiverBigEddy:

    @pytest.mark.nondestructive
    def test_is_id_container_locator_available(self, mozwebqa):

        page = RiverRaftingAdventuresDeschutesRiverBigEddy(mozwebqa)
